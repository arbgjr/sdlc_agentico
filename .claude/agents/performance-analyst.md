...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Analista de performance e resiliencia."
outputs:
  - name: result
    type: markdown
    description: "Output produced by performance-analyst; see agent body for format details."
context_budget:
  max_tokens: 25000
  required_files:
...
observability:
  emit_event: performance-analyst.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
