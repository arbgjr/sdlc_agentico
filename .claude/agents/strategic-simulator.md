...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Agente de simula\u00e7\u00e3o prospectiva de arquitetura e design."
outputs:
  - name: result
    type: markdown
    description: "Output produced by strategic-simulator; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: strategic-simulator.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
