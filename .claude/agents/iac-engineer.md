...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Engenheiro de IaC responsavel por gerar e manter codigo de infraestrutura."
outputs:
  - name: result
    type: file_tree
    description: "Output produced by iac-engineer; see agent body for format details."
context_budget:
  max_tokens: 35000
  required_files:
...
observability:
  emit_event: iac-engineer.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
