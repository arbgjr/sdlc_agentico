...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Agente especializado em extrair e normalizar documentacao oficial."
outputs:
  - name: result
    type: yaml
    description: "Output produced by doc-crawler; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: doc-crawler.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
