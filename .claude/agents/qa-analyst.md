...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Analista de QA que coordena estrategia de testes e valida qualidade."
outputs:
  - name: result
    type: markdown
    description: "Output produced by qa-analyst; see agent body for format details."
context_budget:
  max_tokens: 25000
  required_files:
...
observability:
  emit_event: qa-analyst.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
