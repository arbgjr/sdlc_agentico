...
**📖 Detailed Reference**: [`reference/phases.md`](reference/phases.md)
...
**📖 Detailed Reference**: [`reference/complexity.md`](reference/complexity.md)
...
**📖 Detailed Reference**: [`reference/security.md`](reference/security.md)
...
**📖 Reference**: [`reference/coordination.md`](reference/coordination.md#client-aware-agent-resolution)
...
**📖 References**:
- Phases: [`reference/phases.md`](reference/phases.md)
- Gates: [`reference/gates.md`](reference/gates.md)
- Coordination: [`reference/coordination.md`](reference/coordination.md)
...
**📖 Reference**: [`reference/gates.md`](reference/gates.md)
...
**📖 Reference**: [`reference/security.md`](reference/security.md#escalation-workflow)
...
**📖 Reference**: [`reference/integrations.md`](reference/integrations.md#github-integration)
...
**📖 Reference**: [`reference/integrations.md`](reference/integrations.md#parallel-workers)
...
**📖 Reference**: [`reference/integrations.md`](reference/integrations.md#auto-update-system)
...
**📖 Reference**: [`reference/integrations.md`](reference/integrations.md#spec-kit-integration)
...
**📖 Reference**: [`reference/gates.md`](reference/gates.md#pre-execution-checklist)
...
**📖 Reference**: [`reference/coordination.md`](reference/coordination.md#learning-extraction)
...
| Topic | File |
|-------|------|
| **Phases (0-8)** | [`reference/phases.md`](reference/phases.md) |
| **Complexity Levels** | [`reference/complexity.md`](reference/complexity.md) |
| **Quality Gates & Audits** | [`reference/gates.md`](reference/gates.md) |
| **Agent Coordination** | [`reference/coordination.md`](reference/coordination.md) |
| **Security & Escalation** | [`reference/security.md`](reference/security.md) |
| **External Integrations** | [`reference/integrations.md`](reference/integrations.md) |
...
**📖 Reference**: [`reference/security.md`](reference/security.md#security-gate-integration)
...
**📖 Reference**: [`reference/coordination.md`](reference/coordination.md#orchestrator-inputoutput-formats)
