...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Autor de codigo que implementa features seguindo specs e padroes do projeto."
outputs:
  - name: result
    type: file_tree
    description: "Output produced by code-author; see agent body for format details."
context_budget:
  max_tokens: 40000
  required_files:
...
observability:
  emit_event: code-author.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
