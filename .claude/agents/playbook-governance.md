...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Agente de governanca do playbook. Monitora drift, detecta padroes emergentes,"
outputs:
  - name: result
    type: yaml
    description: "Output produced by playbook-governance; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: playbook-governance.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
