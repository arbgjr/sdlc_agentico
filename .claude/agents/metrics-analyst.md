...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Analista de metricas que rastreia DORA, SPACE e outras metricas de engenharia."
outputs:
  - name: result
    type: markdown
    description: "Output produced by metrics-analyst; see agent body for format details."
context_budget:
  max_tokens: 25000
  required_files:
...
observability:
  emit_event: metrics-analyst.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
