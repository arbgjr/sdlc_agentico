...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Comandante de incidentes que coordena resposta a problemas em producao."
outputs:
  - name: result
    type: yaml
    description: "Output produced by incident-commander; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: incident-commander.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
