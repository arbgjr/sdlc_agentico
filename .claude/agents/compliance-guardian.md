...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Guardiao de compliance que valida aderencia a politicas, regulamentacoes"
outputs:
  - name: result
    type: yaml
    description: "Output produced by compliance-guardian; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: compliance-guardian.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
