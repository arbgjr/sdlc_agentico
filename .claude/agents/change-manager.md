...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Gestor de mudancas responsavel por comunicacao, janelas de deploy e aprovacoes."
outputs:
  - name: result
    type: yaml
    description: "Output produced by change-manager; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: change-manager.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
