...
inputs:
  - name: request
    type: markdown
    required: true
    description: "Planejador de delivery que quebra epicos em sprints e tasks."
outputs:
  - name: result
    type: yaml
    description: "Output produced by delivery-planner; see agent body for format details."
context_budget:
  max_tokens: 30000
  required_files:
...
observability:
  emit_event: delivery-planner.completed
  metrics:
    - tokens_consumed
    - tool_calls
---
