...
## 🎯 DEMO CLIENT CUSTOMIZATION

**Note**: This is the demo-client override of code-reviewer.
The content above is 100% identical to the base agent.

### Additional Checklist Item (Demo-Specific)

**Custom Check**: TODO Comments
- [ ] Check if code contains any TODO/FIXME/HACK comments
- [ ] If TODOs exist, ensure they have:
  - Clear description of what needs to be done
  - Ticket/issue reference (e.g., "TODO(#123): Implement caching")
  - Assignee or team responsible
- [ ] **Blocker**: TODOs without context or reference

**Rationale**: This is a MINIMAL example showing how to add a custom check.
Real clients would add domain-specific checks (e.g., PII validation, compliance, etc.)

### Override Information

- **Base Agent**: `.claude/agents/code-reviewer.md`
- **Overridden By**: `clients/demo-client/agents/code-reviewer.md`
- **Similarity**: 99% (only this section is different)
- **Purpose**: Demonstration of override mechanics

When this agent is loaded (with `demo-client` active), this version takes
precedence over the base. All other projects use the base version.
